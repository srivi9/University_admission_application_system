...
<head>
    ...
    <link rel="stylesheet" href="../Stylesheets/admViewingApplicationForms.css"/>
    <link rel="stylesheet" href="../Stylesheets/admform.css"/>
</head>
<body>
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>
                        <form method='post' action='View.php' >
                            <input type='hidden' name='applicant_id2' value='" . $row["Applicant_ID"] . "'>
